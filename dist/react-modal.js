...
Modal.propTypes = {
  ...
  beforeCloseFunc: _propTypes2.default.func
};
Modal.defaultProps = {
  isOpen: false,
...
var ModalPortal = function (_Component) {
  ...
  function ModalPortal(props) {
    ...
    _this.closeWithTimeout = function (newTimeout) {
      var closesAt = Date.now() + _this.props.closeTimeoutMS;
      _this.setState({ beforeClose: true, closesAt: closesAt }, function () {
        _this.closeTimer = setTimeout(_this.closeWithoutTimeout, newTimeout ? newTimeout : _this.state.closesAt - Date.now());
      });
    };
